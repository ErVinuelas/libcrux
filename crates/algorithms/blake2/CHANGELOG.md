...
- [#1289](https://github.com/celabshq/libcrux/pull/1289): Update dependency `libcrux-traits`

## [0.0.4] (2025-11-05)

- [#1209](https://github.com/celabshq/libcrux/pull/1209): Improve Blake2 API using length trick and expose bounded types
- [#1155](https://github.com/celabshq/libcrux/pull/1155): Add API for initializing digest state
- [#1154](https://github.com/celabshq/libcrux/pull/1154): Blake2: implement `libcrux_traits::digest` traits for supported digest sizes only
