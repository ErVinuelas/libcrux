...
pub(crate) fn init(hash: &mut [u32], kk: u32, nn: u32) {
    ...
    (&mut tmp)[0usize] = nn as u8 as u32
    ...
    (&mut tmp)[3usize] = p.node_offset.wrapping_shr(32u32) as u32
...
fn update_key(wv: &mut [u32], hash: &mut [u32], kk: u32, k: &[u8], ll: u32) {
    ...
    if ll == 0u32 {
        crate::hacl::hash_blake2s::update_block(wv, hash, true, false, lb, &b)
    } else {
        crate::hacl::hash_blake2s::update_block(wv, hash, false, false, lb, &b)
    };
...
pub(crate) fn update_multi(
    ...
    for i in 0u32..nb {
        ...
        crate::hacl::hash_blake2s::update_block(wv, hash, false, false, totlen, b.1)
    }
}
...
pub(crate) fn update_last(
    ...
    crate::hacl::hash_blake2s::update_block(wv, hash, true, last_node, totlen, &b);
    lib::memzero0::memzero::<u8>(&mut b, 64u32)
}
...
fn update_blocks(len: u32, wv: &mut [u32], hash: &mut [u32], prev: u64, blocks: &[u8]) {
    ...
    crate::hacl::hash_blake2s::update_multi(len, wv, hash, prev, blocks, nb0);
    crate::hacl::hash_blake2s::update_last(len, wv, hash, false, prev, rem0, blocks)
}

#[inline]
fn update(wv: &mut [u32], hash: &mut [u32], kk: u32, k: &[u8], ll: u32, d: &[u8]) {
    let lb: u64 = 64u32 as u64;
    if kk > 0u32 {
        crate::hacl::hash_blake2s::update_key(wv, hash, kk, k, ll);
        if ll != 0u32 {
            crate::hacl::hash_blake2s::update_blocks(ll, wv, hash, lb, d)
        }
    } else {
        crate::hacl::hash_blake2s::update_blocks(ll, wv, hash, 0u32 as u64, d)
    }
}
    ...
    match block_state {
        crate::hacl::hash_blake2s::block_state_t { thd: last_node, .. } => {
            ...
            if kk2 != 0u32 {
                ...
                (sub_b.1[0usize..64u32.wrapping_sub(kk2) as usize])
                    .copy_from_slice(&zero_block[0..64u32.wrapping_sub(kk2) as usize]);
...
fn index_of_state(s: &[crate::hacl::hash_blake2s::state_t]) -> crate::hacl::hash_blake2b::index {
    let block_state: &crate::hacl::hash_blake2s::block_state_t = &(s[0usize]).block_state;
    match *block_state {
        crate::hacl::hash_blake2s::block_state_t {
            fst: kk1,
            snd: nn,
...
fn reset_raw<'a>(
    state: &'a mut [crate::hacl::hash_blake2s::state_t],
    key: crate::hacl::hash_blake2b::params_and_key<'a>,
) {
    let block_state: &mut crate::hacl::hash_blake2s::block_state_t =
...
pub fn reset_with_key_and_params(
    s: &mut [crate::hacl::hash_blake2s::state_t],
    p: &[crate::hacl::hash_blake2b::blake2_params],
    k: &[u8],
) {
    let i1: crate::hacl::hash_blake2b::index = crate::hacl::hash_blake2s::index_of_state(s);
    lowstar::ignore::ignore::<crate::hacl::hash_blake2b::index>(i1);
    crate::hacl::hash_blake2s::reset_raw(
        s,
...
*/
pub fn reset_with_key(s: &mut [crate::hacl::hash_blake2s::state_t], k: &[u8]) {
    let idx: crate::hacl::hash_blake2b::index = crate::hacl::hash_blake2s::index_of_state(s);
    let salt: [u8; 8] = [0u8; 8usize];
    let personal: [u8; 8] = [0u8; 8usize];
    let p: crate::hacl::hash_blake2b::blake2_params = crate::hacl::hash_blake2b::blake2_params {
...
behavior is unspecified if you violate this precondition.
*/
pub fn reset(s: &mut [crate::hacl::hash_blake2s::state_t]) {
    crate::hacl::hash_blake2s::reset_with_key(s, &[])
}
...
*/
pub fn update0(
    state: &mut [crate::hacl::hash_blake2s::state_t],
    chunk: &[u8],
    chunk_len: u32,
            ...
            if sz1 != 0u32 {
                ...
                match *block_state {
                    crate::hacl::hash_blake2s::block_state_t {
                        ...
                        let nb: u32 = 1u32;
                        crate::hacl::hash_blake2s::update_multi(64u32, wv, hash, prevlen, buf, nb)
                    }
                }
            };
            ...
            match *block_state {
                crate::hacl::hash_blake2s::block_state_t {
                    ...
                    crate::hacl::hash_blake2s::update_multi(
                        data1_len, wv, hash, total_len1, data2.0, nb,
                    )
                }
            };
            ...
            if sz10 != 0u32 {
                ...
                match *block_state {
                    crate::hacl::hash_blake2s::block_state_t {
                        ...
                        let nb: u32 = 1u32;
                        crate::hacl::hash_blake2s::update_multi(64u32, wv, hash, prevlen, buf0, nb)
                    }
                }
            };
...
*/
pub fn digest(s: &[crate::hacl::hash_blake2s::state_t], dst: &mut [u8]) -> u8 {
    let block_state: &crate::hacl::hash_blake2s::block_state_t = &(s[0usize]).block_state;
    ...
    let block_state0: &crate::hacl::hash_blake2s::block_state_t = &(s[0usize]).block_state;
    ...
    let wv: [u32; 16] = [0u32; 16usize];
    let b: [u32; 16] = [0u32; 16usize];
    let mut tmp_block_state: crate::hacl::hash_blake2s::block_state_t =
        crate::hacl::hash_blake2s::block_state_t {
            fst: i1.key_length,
    ...
    let ite: u32 = if r.wrapping_rem(64u32) == 0u32 && r > 0u32 {
        64u32
    } else {
    ...
    match tmp_block_state {
        crate::hacl::hash_blake2s::block_state_t {
            ...
            let nb: u32 = 0u32;
            crate::hacl::hash_blake2s::update_multi(0u32, wv0, hash, prev_len, buf_last.0, nb)
        }
    };
    ...
    match tmp_block_state {
        crate::hacl::hash_blake2s::block_state_t { snd: nn, .. } => {
            crate::hacl::hash_blake2s::finish(nn as u32, dst, &tmp_block_state.f4)
        }
    };
    let block_state1: &crate::hacl::hash_blake2s::block_state_t = &(s[0usize]).block_state;
    match *block_state1 {
        crate::hacl::hash_blake2s::block_state_t {
            fst: kk,
            snd: nn,
...
pub fn info(s: &[crate::hacl::hash_blake2s::state_t]) -> crate::hacl::hash_blake2b::index {
    let block_state: &crate::hacl::hash_blake2s::block_state_t = &(s[0usize]).block_state;
    match *block_state {
        crate::hacl::hash_blake2s::block_state_t {
            fst: kk,
...
pub fn copy(
    ...
    match *block_state0 {
        crate::hacl::hash_blake2s::block_state_t { f4: ref src_b, .. } => match block_state {
            crate::hacl::hash_blake2s::block_state_t {
                f4: ref mut dst_b, ..
            } => (dst_b[0usize..16usize]).copy_from_slice(&src_b[0usize..16usize]),
        },
...
pub fn hash_with_key(
    ...
    crate::hacl::hash_blake2s::init(&mut b, key_len, output_len);
    crate::hacl::hash_blake2s::update(&mut b1, &mut b, key_len, key, input_len, input);
    crate::hacl::hash_blake2s::finish(output_len, output, &b);
...
pub fn hash_with_key_and_params<'a>(
    ...
    (&mut tmp)[0usize] = params.digest_length as u32
        ^ ((params.key_length as u32).wrapping_shl(8u32)
            ^ ((params.fanout as u32).wrapping_shl(16u32)
                ^ (params.depth as u32).wrapping_shl(24u32)));
    (&mut tmp)[1usize] = params.leaf_length;
    (&mut tmp)[2usize] = params.node_offset as u32;
    (&mut tmp)[3usize] = params.node_offset.wrapping_shr(32u32) as u32
    ...
    r2.0[2usize] = iv6·;
    r2.0[3usize] = iv7·;
    crate::hacl::hash_blake2s::update(
        &mut b1,
        &mut b,
    ...
    crate::hacl::hash_blake2s::finish(params.digest_length as u32, output, &b);
    lib::memzero0::memzero::<u32>(&mut b1, 16u32);
    lib::memzero0::memzero::<u32>(&mut b, 16u32)
}
