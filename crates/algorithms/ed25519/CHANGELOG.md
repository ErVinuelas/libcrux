...
- [#69](https://github.com/celabshq/libcrux/pull/69): Use `no_std` compatible feature configuration on `rand`-feature dependency `rand_core`

## [0.0.9] (2026-07-15)

### Changed

- [#1534](https://github.com/celabshq/libcrux/pull/1534): Update dependency `libcrux-sha2`
...
- [#1349](https://github.com/celabshq/libcrux/pull/1349): Fix Ed25519 error when key generation loop exhausts retries

## [0.0.6] (2026-02-12)

### Fixed

- [#1320](https://github.com/celabshq/libcrux/pull/1320): Remove duplicated clamping step during key generation
...
- [#922](https://github.com/celabshq/libcrux/pull/922): Upgrade `libcrux-sha2` dependency
